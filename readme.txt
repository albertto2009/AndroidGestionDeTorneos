...
1º- Hay dos formas de acceder a la aplicacion:
- Cuenta de administrador(usuario: root, contraseña: root)
- Cuenta de usuario creado previamente por el administrador y esta almacenado en la tabla usuarios cuyo login es su codigo y su nombre su pass,
  se comprueba si la contraseña es valida haciendo una consulta a la tabla.
**en el menu hay un textview con la contraseña del usuario por si es el caso que no la recordemos**
